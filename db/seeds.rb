...
lg = Corporation.create(name: 'LG', founded: DateTime.new.utc(1966, 2, 3),
                        founder: 'Koo In-hwoi',
                        revenue: 143, area_served: 'Worldwide', rating: 8)

samsung = Corporation.create(name: 'Samsung', founded: DateTime.new.utc(1938, 3, 1),
                             founder: 'Lee Byung-chul',
                             revenue: 305, area_served: 'Worldwide', rating: 9)

apple = Corporation.create(name: 'Apple', founded: DateTime.new.utc(1976, 4, 1),
                           founder: 'Steve Jobs',
...
lg_tv_60 = lg.items.create(item_type: 'Electronics', model: "LG 60'", price: 999)

galaxy_s_8 = samsung.items.create(item_type: 'Electronics', model: 'Galaxy S8', price: 1000)
